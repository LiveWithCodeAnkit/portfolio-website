  ...
  return (
    <div className="flex flex-col flex-grow px-6 pt-1 ">
      <h6 className="my-3 text-base font-medium">
        I have completed Masters in Computer Application Degree  from Sarvajanik
        College of Engineering & Technology. I am interested in working in Full
        Stack Development.
      </h6>
      <div
        className="flex-grow p-4 mt-5 bg-blue-300 dark:bg-dark-100 "
